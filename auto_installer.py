...
def menu():
    ...
    print("""
  AAA   UU   UU TTTTTTT  OOOOO          IIIII NN   NN  SSSSS  TTTTTTT   AAA   LL      LL      EEEEEEE RRRRRR
 AAAAA  UU   UU   TTT   OO   OO          III  NNN  NN SS        TTT    AAAAA  LL      LL      EE      RR   RR
AA   AA UU   UU   TTT   OO   OO          III  NN N NN  SSSSS    TTT   AA   AA LL      LL      EEEEE   RRRRRR
AAAAAAA UU   UU   TTT   OO   OO          III  NN  NNN      SS   TTT   AAAAAAA LL      LL      EE      RR  RR
AA   AA  UUUUU    TTT    OOOO0  _______ IIIII NN   NN  SSSSS    TTT   AA   AA LLLLLLL LLLLLLL EEEEEEE RR   RR


Created By LocalHost 229
Instagram:www.instagram.com/wardnaa__
Team     :anon_cyber_team
         :Anak Bawang Cyber
Ver: 0.1
----
ONLY FOR TERMUX!
----
==========================================
00.Android Engine Hacking Tools (INSTALL SEMUA)
------------------------------------------
1.  Install Nmap
2.  Install Hydra
3.  Install SQLMap
...
while loop:
    ...
    if what == "00":
        ...
        if hm == "y":
            print("========================================================")
            print("[+] Please put down you android and go to save this world :v ...")
